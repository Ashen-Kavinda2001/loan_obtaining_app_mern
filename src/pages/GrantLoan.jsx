...
import { demoMembers, formatCurrency } from '../data/demoData';

const initialForm = {
  memberId: '', loanAmount: '', interestRate: 30, loanDuration: '', startDate: ''
};

// Field wrapper defined OUTSIDE to avoid re-mount on every render
...
export default function GrantLoan() {
  ...
  // Derived calculation — useMemo is correct here (no side effects needed)
  const calc = useMemo(() => {
  ...
  const selectedMember = demoMembers.find(m => m._id === form.memberId);
        ...
        <div>
          {success && (
            <div style={{
              ...
              padding: '14px 18px', marginBottom: 20, fontSize: 13, color: '#065F46', fontWeight: 600
            }}>
          ...
          <div className="card">
            ...
            <form onSubmit={handleSubmit} noValidate>
              {/* Member Selector */}
              <Field name="memberId" label="Select Member *" error={errors.memberId}>
                <select
              ...
              {selectedMember && (
                <div style={{
                  background: '#F8FAFC', border: '1px solid var(--color-border)', borderRadius: 'var(--radius-sm)',
              ...
              <div className="form-grid-2">
                <Field name="loanAmount" label="Loan Amount (Rs.) *" error={errors.loanAmount}>
                ...
                <Field name="loanDuration" label="Duration (Months) *" error={errors.loanDuration}>
              ...
              <div style={{ display: 'flex', gap: 12, marginTop: 8 }}>
                <button type="submit" className="btn btn-success"><CreditCard size={15} /> Grant Loan</button>
          ...
          <div className="card" style={{ position: 'sticky', top: 80 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              ...
              <div style={{
                ...
                borderRadius: 'var(--radius-md)', padding: '16px', textAlign: 'center', color: '#fff'
              }}>
