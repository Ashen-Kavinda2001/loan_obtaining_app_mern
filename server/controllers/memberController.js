...
const createMember = async (req, res) => {
  try {
    const { fullName, idNumber, village, contactNumber, age } = req.body;
    ...
    const member = await Member.create({ fullName, idNumber, village, contactNumber, age });
...
const updateMember = async (req, res) => {
  try {
    ...
    // Check NIC uniqueness (exclude current member)
    ...
    Object.assign(member, { fullName, idNumber, village, contactNumber, age });
