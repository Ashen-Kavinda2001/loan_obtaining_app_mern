...
const sendOtpEmail = async (toEmail, otp) => {
  ...
  if (!user || !pass) {
    const msg = 'Email is not configured. Set EMAIL_USER and EMAIL_PASS in server/.env.';
  ...
  const mailOptions = {
    from: `"FGI Loan System" <${process.env.EMAIL_USER}>`,
    to:   toEmail,
    subject: 'Your Password Reset Code — FGI Loans',
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 480px; margin: auto; padding: 32px; border: 1px solid #E2E8F0; border-radius: 12px;">
        ...
        <p style="color: #475569; margin-bottom: 24px;">Use the code below to reset your FGI Loan System password. It expires in <strong>15 minutes</strong>.</p>
        ...
        <p style="color: #94A3B8; font-size: 13px;">If you didn't request this, please ignore this email. Your password won't change.</p>
      </div>
    `,
  };
